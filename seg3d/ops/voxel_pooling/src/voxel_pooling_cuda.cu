...
__global__ void voxel_pooling_forward_kernel(int N, int c, int s,
...
template <typename scalar_t>
__global__ void voxel_pooling_backward_kernel(int N, int c, int s,
...
at::Tensor voxel_pooling_forward_cuda(const at::Tensor inputs, const at::Tensor idx,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      inputs.type(), "voxel_pooling_forward_cuda", ([&] {
        voxel_pooling_forward_kernel<scalar_t><<<N, c>>>(
...
at::Tensor voxel_pooling_backward_cuda(const at::Tensor top_grad,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      top_grad.type(), "voxel_pooling_backward_cuda", ([&] {
        voxel_pooling_backward_kernel<scalar_t><<<N, c>>>(
