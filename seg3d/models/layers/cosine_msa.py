...
def cosine_multi_head_attention_forward(
    ...
    #
    attn_output, attn_output_weights = _scaled_cosine_attention(q, k, v, tau, tau_min, num_heads, attn_mask, extra_attn,
                                                                dropout_p)
...
class CosineMultiheadAttention(nn.MultiheadAttention):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
                 kdim=None, vdim=None, batch_first=False, cosine=True, tau_min=0.01,
                 non_shared_tau=False) -> None:
